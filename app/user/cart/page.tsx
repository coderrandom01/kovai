      ...
      {cart.length === 0 ? (
        ...
        <>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className='w-16 sm:w-40 md:w-60 '>
                    ...
                    <p className="text-sm text-gray-500">₹{item.display_price} x {item.count} = {item.display_price * item.count}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="bg-gray-100 w-7 h-7 rounded-full text-sm font-bold"
                  >
                    −
                  </button>
          ...
          <div className="mt-8 border-t pt-6">
            ...
            <button onClick={() => setShowModal(true)} className="mt-6 bg-rose-300 hover:bg-rose-400 text-white px-6 py-2 rounded">
              Proceed to Checkout
            </button>
          </div>
        </>
